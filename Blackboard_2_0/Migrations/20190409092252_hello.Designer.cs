...
namespace Blackboard_2_0.Migrations
{
    ...
    [Migration("20190409092252_hello")]
    partial class hello
    {
            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Calendar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = 1,
                            CourseId = 1,
                            EventDate = new DateTime(2019, 4, 19, 11, 22, 51, 621, DateTimeKind.Local).AddTicks(873),
                        ...
                        new
                        {
                            EventId = 2,
                            CourseId = 2,
                            EventDate = new DateTime(2019, 4, 13, 15, 22, 51, 621, DateTimeKind.Local).AddTicks(4642),
                        ...
                        new
                        {
                            EventId = 3,
                            CourseId = 2,
                            EventDate = new DateTime(2019, 4, 29, 11, 22, 51, 621, DateTimeKind.Local).AddTicks(4674),
                            EventName = "Opgaver",
                            Type = "Group work"
                        },
                        new
                        {
                            EventId = 4,
                            CourseId = 3,
                            EventDate = new DateTime(2019, 4, 11, 11, 22, 51, 621, DateTimeKind.Local).AddTicks(4681),
            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Birthday = new DateTime(2019, 4, 9, 11, 22, 51, 615, DateTimeKind.Local).AddTicks(4359),
                            EnrolledDate = new DateTime(2019, 3, 30, 11, 22, 51, 617, DateTimeKind.Local).AddTicks(6450),
                            FirstName = "Thomas",
                            GraduationDate = new DateTime(2020, 3, 24, 11, 22, 51, 617, DateTimeKind.Local).AddTicks(7124),
                            LastName = "Moeller"
                        },
                        new
                        {
                            Id = 2,
                            Birthday = new DateTime(2016, 7, 13, 11, 22, 51, 617, DateTimeKind.Local).AddTicks(8888),
                            EnrolledDate = new DateTime(2018, 12, 30, 11, 22, 51, 617, DateTimeKind.Local).AddTicks(8905),
                            FirstName = "Oskar",
                            GraduationDate = new DateTime(2019, 12, 15, 11, 22, 51, 617, DateTimeKind.Local).AddTicks(8916),
                            LastName = "Hansen"
                        });
                });
            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Teacher", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Birthday = new DateTime(2017, 11, 25, 11, 22, 51, 618, DateTimeKind.Local).AddTicks(746),
                            FirstName = "Mathias",
                            LastName = "Thomassen"
                        },
                        new
                        {
                            Id = 4,
                            Birthday = new DateTime(2016, 7, 13, 11, 22, 51, 618, DateTimeKind.Local).AddTicks(2431),
                            FirstName = "Valdemar",
                            LastName = "Tang"
                        });
                });
