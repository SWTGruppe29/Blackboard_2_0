...
namespace Blackboard_2_0.Migrations
{
    ...
    [Migration("20190408113720_OneToManyCourseCalendar")]
    partial class OneToManyCourseCalendar
    {
            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Calendar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = 1,
                            CourseId = 1,
                            EventDate = new DateTime(2019, 4, 18, 13, 37, 19, 255, DateTimeKind.Local).AddTicks(8480),
                        ...
                        new
                        {
                            EventId = 2,
                            CourseId = 2,
                            EventDate = new DateTime(2019, 4, 12, 17, 37, 19, 256, DateTimeKind.Local).AddTicks(988),
                        ...
                        new
                        {
                            EventId = 3,
                            CourseId = 2,
                            EventDate = new DateTime(2019, 4, 28, 13, 37, 19, 256, DateTimeKind.Local).AddTicks(1019),
                            EventName = "Opgaver",
                            Type = "Group work"
                        },
                        new
                        {
                            EventId = 4,
                            CourseId = 3,
                            EventDate = new DateTime(2019, 4, 10, 13, 37, 19, 256, DateTimeKind.Local).AddTicks(1026),
            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Birthday = new DateTime(2019, 4, 8, 13, 37, 19, 248, DateTimeKind.Local).AddTicks(9598),
                            EnrolledDate = new DateTime(2019, 3, 29, 13, 37, 19, 251, DateTimeKind.Local).AddTicks(7494),
                            FirstName = "Thomas",
                            GraduationDate = new DateTime(2020, 3, 23, 13, 37, 19, 251, DateTimeKind.Local).AddTicks(8305),
                            LastName = "Moeller"
                        },
                        new
                        {
                            Id = 2,
                            Birthday = new DateTime(2016, 7, 12, 13, 37, 19, 252, DateTimeKind.Local).AddTicks(363),
                            EnrolledDate = new DateTime(2018, 12, 29, 13, 37, 19, 252, DateTimeKind.Local).AddTicks(384),
                            FirstName = "Oskar",
                            GraduationDate = new DateTime(2019, 12, 14, 13, 37, 19, 252, DateTimeKind.Local).AddTicks(397),
                            LastName = "Hansen"
                        });
                });
            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Teacher", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Birthday = new DateTime(2017, 11, 24, 13, 37, 19, 252, DateTimeKind.Local).AddTicks(2582),
                            FirstName = "Mathias",
                            LastName = "Thomassen"
                        },
                        new
                        {
                            Id = 4,
                            Birthday = new DateTime(2016, 7, 12, 13, 37, 19, 252, DateTimeKind.Local).AddTicks(4552),
                            FirstName = "Valdemar",
                            LastName = "Tang"
                        });
                });
