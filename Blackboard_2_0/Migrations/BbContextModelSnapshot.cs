            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Calendar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = 1,
                            CourseId = 1,
                            EventDate = new DateTime(2019, 4, 18, 12, 57, 23, 715, DateTimeKind.Local).AddTicks(6750),
                        ...
                        new
                        {
                            EventId = 2,
                            CourseId = 2,
                            EventDate = new DateTime(2019, 4, 12, 16, 57, 23, 715, DateTimeKind.Local).AddTicks(8318),
                        ...
                        new
                        {
                            EventId = 3,
                            CourseId = 2,
                            EventDate = new DateTime(2019, 4, 28, 12, 57, 23, 715, DateTimeKind.Local).AddTicks(8333),
                            EventName = "Opgaver",
                            Type = "Group work"
                        },
                        new
                        {
                            EventId = 4,
                            CourseId = 3,
                            EventDate = new DateTime(2019, 4, 10, 12, 57, 23, 715, DateTimeKind.Local).AddTicks(8338),
            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Birthday = new DateTime(2019, 4, 8, 12, 57, 23, 710, DateTimeKind.Local).AddTicks(4753),
                            EnrolledDate = new DateTime(2019, 3, 29, 12, 57, 23, 713, DateTimeKind.Local).AddTicks(2358),
                            FirstName = "Thomas",
                            GraduationDate = new DateTime(2020, 3, 23, 12, 57, 23, 713, DateTimeKind.Local).AddTicks(2878),
                            LastName = "Moeller"
                        },
                        new
                        {
                            Id = 2,
                            Birthday = new DateTime(2016, 7, 12, 12, 57, 23, 713, DateTimeKind.Local).AddTicks(4158),
                            EnrolledDate = new DateTime(2018, 12, 29, 12, 57, 23, 713, DateTimeKind.Local).AddTicks(4173),
                            FirstName = "Oskar",
                            GraduationDate = new DateTime(2019, 12, 14, 12, 57, 23, 713, DateTimeKind.Local).AddTicks(4178),
                            LastName = "Hansen"
                        });
                });
            ...
            modelBuilder.Entity("Blackboard_2_0.Models.Data.Teacher", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Birthday = new DateTime(2017, 11, 24, 12, 57, 23, 713, DateTimeKind.Local).AddTicks(5504),
                            FirstName = "Mathias",
                            LastName = "Thomassen"
                        },
                        new
                        {
                            Id = 4,
                            Birthday = new DateTime(2016, 7, 12, 12, 57, 23, 713, DateTimeKind.Local).AddTicks(6666),
                            FirstName = "Valdemar",
                            LastName = "Tang"
                        });
                });
